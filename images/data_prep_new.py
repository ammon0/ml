...
### file directories for training and test images on the VM; original, cropped and resized
...
face_cascade = cv2.CascadeClassifier('/home/matthew/opencv/data/haarcascades/haarcascade_frontalface_default.xml')
...
def modify_csv(fileList):
    ...
    df = pandas.read_csv('/home/matthew/SCHOOL/TCSS455/tcss455/training/profile/profile.csv', index_col=0)
