...
def likeLogReg(profileTable, relationTable):
    ...
    #print('1')
    #print(relationTable)
    cv = load('/home/itadmin/ml/likes/gender_LogisticRegression2_jake_cv.joblib')
    #cv = CountVectorizer()
    ...
    #print(results)    
    likeLogisticRegression = load('/home/itadmin/ml/likes/gender_LogisticRegression2_jake.joblib')
    
    results['gender'] = likeLogisticRegression.predict(X).astype(int)
    #print('3')
    #print(results)
    if TESTING:
...
def likeLogReg(profileTable, relationTable):
    ...
    if TESTING:
        ...
        print(copy)
        print(results)
        print(metrics.accuracy_score(copy['gender'],results['gender']))
    return results
